...
{ 
 ...
 // Build fluid mesh
 Fluid_mesh_pt=new MacroElementNodeUpdateRefineableQuarterCircleSectorMesh<ELEMENT>(
...
int main(int argc, char* argv[])
{
 ...
 OscRingNStProblem<MacroElementNodeUpdateElement<RefineableQCrouzeixRaviartElement<2> > >
 ...
 if (CommandLineArgs::Argc==3)
  {
   ...
   // Set up the problem: Pass timestep and Sarah's asymptotic solution for
   // generation of initial condition
   OscRingNStProblem<MacroElementNodeUpdateElement<
