...
//LIC// 
//LIC//    Version 1.0; svn revision $LastChangedRevision: 1163 $
//LIC//
//LIC// $LastChangedDate: 2016-04-20 16:36:18 +0100 (Wed, 20 Apr 2016) $
//LIC// 
...
namespace Global_Physical_Variables
{
 ...
 /// \short Max. pressure. Only used in steady runs during parameter
 /// incrementation. Use 2.0 for Re=250; 3.7 for Re=0 to
 /// span the range in Heil (2004) paper. 
 double Pmax=2.0;

 /// \short Jump in pressure after a restart --  used to give a steady
 /// solution a kick before starting a time-dependent run
 double P_step=0.0;

 /// \short Current prescribed vertical position of control point 
...
namespace Flags
{
 ...
 /// \short Number of steps in parameter study
 unsigned Nsteps=5;
