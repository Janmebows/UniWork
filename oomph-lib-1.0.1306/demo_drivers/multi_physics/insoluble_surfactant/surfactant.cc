...
//In addition the transport of an insoluble surfactant on the interface
//and its effect on the convection is also considered
//N.B. Physical parameters, etc, are not validated!
...
//This includes the standard Boussinesq elements
 ...
 if(time <= 0.0)
  {
   ...
   //Set the initial concentration to be one
   unsigned ibound = 2;
