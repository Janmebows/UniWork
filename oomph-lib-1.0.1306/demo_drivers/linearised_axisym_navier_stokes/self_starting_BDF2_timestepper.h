...
namespace oomph
{
 ...
 class SelfStartingBDF2 : public TimeStepper
 {
  ...
  /// \short Bool to indicate if the timestepper is in `BDF1' mode
  ...
  SelfStartingBDF2(const bool& adaptive=false) : TimeStepper(3,1), BDF1_mode(false)
   ...
   /// \short Reset the timestepper to BDF2: Set the "BDF1_mode"
   ...
   /// \short Implementation of pure virtual function in base class.
